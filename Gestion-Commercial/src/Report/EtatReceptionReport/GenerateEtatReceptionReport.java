...
public class GenerateEtatReceptionReport {
    ...
    public void generateReport(Date startDate, Date endDate ) {
        ...
        double montantCheque=round(prixOAIC*totalFour, 2);
        ...
        for (int i = 0; i < jour.size(); i++) {
            ...
            operationEtatReceptionReport.putReportInfo(newStartDate, newEndDate,
                    dateJour, String.valueOf(totalFour), String.valueOf(totalMoulin),
