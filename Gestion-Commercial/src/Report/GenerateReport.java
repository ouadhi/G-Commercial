...
public class GenerateReport {
	...
	public void generateReport() throws IOException, JRException {
		...
		for (int i = 0; i < listFactures.size(); i++) {
			...
			tableExecute.putReportInfo(nom, code, address, rc, fiscal, date, numFacture, article, montantHT, tva,
					timbre, ttc, montantlettre, chauffeur, matricule, listdes, listqte, listprix, listmont);
