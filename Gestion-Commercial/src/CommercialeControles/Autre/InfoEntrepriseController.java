...
public class InfoEntrepriseController implements Initializable {
    ...
    private void save(ActionEvent event) {
        ...
        if (!(registreVal.isEmpty() || fiscaleVal.isEmpty() || articlVal.isEmpty() || telVal.isEmpty()
                || faxVal.isEmpty() || emailVal.isEmpty() || nomVal.isEmpty() || addressVal.isEmpty())) {
            if (com == null) {
                Company company = new Company(nomVal, registreVal, fiscaleVal, articlVal, emailVal, telVal, faxVal, addressVal);
